...
const PAGE_META: Record<string, { title: string; breadcrumb: string[] }> = {
  ...
  '/content':             { title: 'Vue d\'ensemble — Contenu', breadcrumb: ['Home', 'Workspace', 'Contenu'] },
  '/content/projects':    { title: 'Projets vidéo',             breadcrumb: ['Home', 'Contenu', 'Projets'] },
  '/content/ideas':       { title: 'Idées & Captures',          breadcrumb: ['Home', 'Contenu', 'Idées'] },
  '/content/suggestions': { title: 'Suggestions IA',            breadcrumb: ['Home', 'Contenu', 'Suggestions'] },
  '/content/creators':    { title: 'Créateurs',                 breadcrumb: ['Home', 'Contenu', 'Créateurs'] },
